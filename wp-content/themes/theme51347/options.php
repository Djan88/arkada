...
// ---------------------------------------------------------
			...
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '30px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#FFFFFF'));
			
			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '25px', 'lineheight' => '25px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#FFFFFF'));
								
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '23px', 'lineheight' => '23px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#FFFFFF'));
			...
			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#FFFFFF'));
								
			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '16px', 'lineheight' => '16px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#FFFFFF'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '14px', 'lineheight' => '33px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#818c93'));
